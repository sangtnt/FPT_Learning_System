namespace FPT_Learning_System.Migrations
{
    ...
    public partial class updatedata : DbMigration
    {
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false, identity: true),
                        CourseName = c.String(),
                        CourseCategory_Id = c.String(),
                        CourseCategory_Id1 = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.CourseCategories", t => t.CourseCategory_Id1)
                .Index(t => t.CourseCategory_Id1);
                ...
                c => new
                    {
                        ...
                        Avartar = c.String(),
                        Education = c.String(),
                        MainProgrammingLanguages = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Courses", "CourseCategory_Id1", "dbo.CourseCategories");
